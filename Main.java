...
public class Stagegenerator {
    ...
    public Scene Sixteenplayers() {
        ...
        TextField t5 = new TextField (); //t5.setMaxWidth(70);
        TextField t6 = new TextField (); //t6.setMaxWidth(70);      
        TextField t7 = new TextField (); //t7.setMaxWidth(70);
        TextField t8 = new TextField (); //t8.setMaxWidth(70);
        TextField t9 = new TextField (); //t9.setMaxWidth(70);
        TextField t10 = new TextField (); //t10.setMaxWidth(70);          
        TextField t11 = new TextField (); //t11.setMaxWidth(70);  
        TextField t12 = new TextField (); //t12.setMaxWidth(70);  
        TextField t13 = new TextField (); //t13.setMaxWidth(70);  
        TextField t14 = new TextField (); //t15.setMaxWidth(70);            
        TextField t15 = new TextField (); //t16.setMaxWidth(70);
...
//layout left         
        ...
        layout1.setLayoutX(20);
        layout1.setMaxWidth(100);
...
//layoutV2
        ...
        layout3.setLayoutX(200);
        layout3.setLayoutY(50);
        layout3.setMaxWidth(100);      
